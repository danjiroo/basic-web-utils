...
export declare type FieldRuleTypes = 'required' | 'isValidEmail' | 'isValidPassword' | 'isValidUrl' | 'minLength';
 ...
 */
export declare type Fields<TFieldNames extends string = string, TFieldOptions = Record<string, any>[]> = {
 ...
 */
export declare type FieldRules<TFieldNames extends string = string> = {
    [P in TFieldNames]?: {
